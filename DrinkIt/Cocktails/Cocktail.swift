...
struct Cocktail: Identifiable {
  ...
  init(
    ...
    uncommonQuantities: [Double],
    uncommonQuantitiesTypes: [String],
    commonIngredients: [String],
    commonQuantities: [Double],
    commonQuantitiesTypes: [String],
    garnish: [String],
    glassKind: String,
    recipe: [String],
    summary: String,
  ...
  init() {
    self.init(
      ...
      uncommonIngredients: [],
      uncommonQuantities: [],
      uncommonQuantitiesTypes: [],
      commonIngredients: [],
      commonQuantities: [],
      commonQuantitiesTypes: [],
      garnish: [],
      glassKind: "",
      recipe: [],
      summary: "",
